...
| 16    | 70            | Հ &nbsp; հ    | հո        | *հ* ( *head* )              |  `H`        | ա. ցուցամատ       |
...
| 24    | 600           | Ո &nbsp; ո    | վօ        | *vo* ( *voice* )            |  `U`        | ա. ցուցամատ       |
...
&nbsp;&nbsp;&nbsp;&nbsp;Նկատեք, որ *Քաոս* բառը մուտքագրելուց հետո սեղմվում է ավելորդ բացատ։ Դա անհրաժեշտ է, քանի որ `S` ստեղնը բաղադրյալ է, որը սեղմելուց հետո սպասում է հաջորդ ոչ բաղադրյալ ստեղնի սեղմվելուն։ Նկատեք նաև, որ *թխկի* բառը մուտքագրելիս սեղմվում է բացատ *թ* տառից հետո։ Դա պայմանավորված է նրանով, որ `T` բաղադրյալ ստեղնին հաջորդում է `K` բաղադրյալ ստեղնը։ Սակայն [Keyman](#windows-macos-linux) հարթակի վրա կամ [macOS](#macos) ՕՀ-ում այդպիսի բացատների կարիքը չկա, նաև, macOS ՕՀ-ում բաղադրյալ ստեղնը սեղմելիս, անմիջապես մուտքագվում է համապատասխան առաջին տառը՝ վառ ընդգծված։ Այս ստեղնաշարը նախագծվել է այնպես, որ բաղադրյալ ստեղները լինեն հնարավորինս չափ քիչ, և, հետևաբար, չդանդաղեցնի տպելը։ Ուշադրություն դարձրեք այն բանին, որ գոյականի՝ հաճախ հանդիպող *թյուն* վերջածանցին համապատասխանող ստեղները գտնվում են ցուցամատների մոտ, ինչպես անգլերենի *tion* վերջածանցը։ Դա մյուս կողմից նպաստում է արագ տպելուն։
...
| :---                                    |  :---:  | :---            |    :---:      |
| [055f](https://unicode-table.com/ru/)   | ՟   | պատիվ[^pativ]   |   `/` `-`         |
| [00a7](https://unicode-table.com/ru/)   | §   | բաժին           |   `AltGr`+`S`     |
| [00b6](https://unicode-table.com/ru/)   | ¶   | ենթաբաժին       |   `AltGr`+`P`     |
| [2116](https://unicode-table.com/ru/)   | №   | համարանիշ       |   `AltGr`+`N`     |
| [2103](https://unicode-table.com/ru/)   | ℃  | աստիճան ըստ Ցելսիուսի | `AltGr`+`C`     |
| [00a4](https://unicode-table.com/ru/)   | ¤   | արժույթ         |   `AltGr`+`Shift`+`X` |
| [058f](https://unicode-table.com/ru/)   | ֏   | դրամ            |   `AltGr`+`D`     |
| [20ac](https://unicode-table.com/ru/)   | €   | եվրո            |   `AltGr`+`E`     |
| [20bd](https://unicode-table.com/ru/)   | ₽   | ռուբլի          |   `AltGr`+`R`     |
| [20b4](https://unicode-table.com/ru/)   | ₴   | հրիվնյա         |   `AltGr`+`G`     |
| [00a3](https://unicode-table.com/ru/)   | £   | ֆունտ սթերլինգ  |   `AltGr`+`F`     |
| [20a3](https://unicode-table.com/ru/)   | ₣   | ֆրանկ           |   `AltGr`+`Shift`+`F` |
| [20be](https://unicode-table.com/ru/)   | ₾   | լարի            |   `AltGr`+`Լ`     |
| [20a4](https://unicode-table.com/ru/)   | ₤   | լիրա            |   `AltGr`+`Shift`+`Լ` |
| [00a5](https://unicode-table.com/ru/)   | ¥   | յեն             |   `AltGr`+`Y`     |
| [20b9](https://unicode-table.com/ru/)   | ₹   | րուպի           |   `AltGr`+`I`     |
| [2022](https://unicode-table.com/ru/)   | •   | ցանկի մակնշան կետային |   `AltGr`+`Shift`+`B` |
| [2023](https://unicode-table.com/ru/)   | ‣   | ցանկի մակնշան եռանկյունային |   `AltGr`+`Shift`+`V` |
| [2043](https://unicode-table.com/ru/)   | ⁃   | ցանկի մակնշան գծային |   `AltGr`+`Shift`+`N` |
| [007e](https://unicode-table.com/ru/)   | ~   | տիլդա           |   `AltGr`+`Shift`+`՝` |
| [0060](https://unicode-table.com/ru/)   | \`  | լատինական բութ  |   `AltGr`+`՝`     |
| [003a](https://unicode-table.com/ru/)   | :   | լատինական երկկետ  |   `AltGr`+`Shift`+`;` |
| [003f](https://unicode-table.com/ru/)   | ?   | լատինական հարցական  |   `AltGr`+`Shift`+`/` |
| [00a9](https://unicode-table.com/ru/)   | ©   | հեղինակային իրավունք  |   `AltGr`+`Shift`+`C` |
| [00ae](https://unicode-table.com/ru/)   | ®   | ապրանքանշանի իրավունք |   `AltGr`+`Shift`+`R` |
| [2122](https://unicode-table.com/ru/)   | ™   | ապրանքանիշ      |   `AltGr`+`Shift`+`T` |
| [2120](https://unicode-table.com/ru/)   | ℠  | սպասարկման նշան |   `AltGr`+`Shift`+`S` |
| [00aa](https://unicode-table.com/ru/)   | ª   | դասական թվականի ցուցիչ (իգական)  |   `AltGr`+`A` |
| [00ba](https://unicode-table.com/ru/)   | º   | դասական թվականի ցուցիչ (արական)  |   `AltGr`+`O` |
| [058e](https://unicode-table.com/ru/)   | ֎   | հայկական հավերժության նշան (ձախ) |  `AltGr`+`H` |
| [058d](https://unicode-table.com/ru/)   | ֍   | հայկական հավերժության նշան (աջ)  |  `AltGr`+`Shift`+`H` |
...
| Յունիկոդ №                             | Սիմվոլը   | Անվանումը   | Ստեղները      |
| :---                                   |  :---:    | :---        |    :---:      |
| [00b0](https://unicode-table.com/ru/)  | °     | աստիճան         |   `AltGr`+`Shift`+`Օ` |
| [2032](https://unicode-table.com/ru/)  | ′     | մանրագծիկ (րոպե, ոտնաչափ)      |   `/` `'`     |
| [2033](https://unicode-table.com/ru/)  | ″     | կրկնակի մանրագծիկ (վայրկյան, դույմ) |   `/` `Shift`+`'` |
| [2034](https://unicode-table.com/ru/)  | ‴     | եռակի մանրագծիկ |   `/` `;`     |
| [207a](https://unicode-table.com/ru/)  | ⁺     | տողավերևի գումարում |  `AltGr`+`Shift`+`P` |
| [207b](https://unicode-table.com/ru/)  | ⁻     | տողավերևի հանում |  `AltGr`+`Shift`+`M` |
| [00d7](https://unicode-table.com/ru/)  | ×     | բազմապատկում    |   `AltGr`+`X` |
| [2219](https://unicode-table.com/ru/)  | ·     | բազմապատկում    |   `AltGr`+`.` |
| [2212](https://unicode-table.com/ru/)  | −     | հանում          |   `\` `-` |
| [00f7](https://unicode-table.com/ru/)  | ÷     | բաժանում        |   `AltGr`+`/` |
| [221a](https://unicode-table.com/ru/)  | √     | քառակուսի արմատ |   `AltGr`+`V` |
| [2248](https://unicode-table.com/ru/)  | ≈     | մոտավորապես հավասար լինել |  `AltGr`+`=` |
| [2261](https://unicode-table.com/ru/)  | ≡     | նույնական լինել |   `\` `=`     |
| [2260](https://unicode-table.com/ru/)  | ≠     | հավասար չլինել  |   `/` `=`     |
| [00b1](https://unicode-table.com/ru/)  | ±     | պլյուս-մինուս   |   `\` `+`     |
| [2264](https://unicode-table.com/ru/)  | ≤     | փոքր կամ հավասար լինել |  `\` `<`   |
| [2265](https://unicode-table.com/ru/)  | ≥     | մեծ կամ հավասար լինել |   `\` `>`   |
| [221e](https://unicode-table.com/ru/)  | ∞     | անվերջություն   |   `\` `8`     |
| [2030](https://unicode-table.com/ru/)  | ‰     | հազարերորդական մաս  |   `AltGr`+`M`   |
| [2031](https://unicode-table.com/ru/)  | ‱     | տասը հազարերորդական մաս  |   `AltGr`+`T`   |
| [2329](https://unicode-table.com/ru/)  | 〈    | ձախ անկյունային փակագիծ | `\` `[` |
| [232a](https://unicode-table.com/ru/)  | 〉    | աջ անկյունային փակագիծ | `\` `]` |
| [2220](https://unicode-table.com/ru/)  | ∠     | անկյուն         |   `/` `L`     |
| [221f](https://unicode-table.com/ru/)  | ∟     | ուղիղ անկյուն   |   `\` `L`     |
| [27c2](https://unicode-table.com/ru/)  | ⟂     | ուղղահայաց լինել |   `\` `T`     |
| [2200](https://unicode-table.com/ru/)  | ∀     | բոլորի համար    |   `\` `A`     |
| [2203](https://unicode-table.com/ru/)  | ∃     | գոյություն ունենալ |   `\` `E`     |
| [2204](https://unicode-table.com/ru/)  | ∄     | գոյություն չունենալ  | `/` `E`     |
| [2228](https://unicode-table.com/ru/)  | ∨     | տրամաբանական գումարում (կամ) | `\` `V` |
| [2227](https://unicode-table.com/ru/)  | ∧     | տրամաբանական բազմապատկում (և) | `/` `V` |
| [00ac](https://unicode-table.com/ru/)  | ¬     | տրամաբանական ժխտում (ոչ)     |   `/` `N`   |
| [2205](https://unicode-table.com/ru/)  | ∅     | դատարկ բազմություն  | `/` `0` |
| [227a](https://unicode-table.com/ru/)  | ≺     | նախորդել     |   `\` `{`   |
| [227b](https://unicode-table.com/ru/)  | ≻     | հաջորդել     |   `\` `}`   |
| [2282](https://unicode-table.com/ru/)  | ⊂     | ենթաբազմություն լինել |   `\` `C`   |
| [2284](https://unicode-table.com/ru/)  | ⊄     | ենթաբազմություն չլինել | `/` `C` |
| [2208](https://unicode-table.com/ru/)  | ∈     | պատկանել |   `\` `B`   |
| [2209](https://unicode-table.com/ru/)  | ∉     | չպատկանել    |  `/` `B`  |
| [222a](https://unicode-table.com/ru/)  | ∪     | միավորում     |   `\` `U`   |
| [2229](https://unicode-table.com/ru/)  | ∩     | հատում      |   `/` `U`   |
| [2218](https://unicode-table.com/ru/)  | ∘     | օղակ օպերատոր |   `\` `O` |
| [2217](https://unicode-table.com/ru/)  | ∗     | աստղանիշ օպերատոր |  `\` `*` |
| [22c6](https://unicode-table.com/ru/)  | ⋆     | աստղ օպերատոր   |   `/` `*`   |
| [21a6](https://unicode-table.com/ru/)  | ↦     | ապացույցի սկիզբ |   `/` `>`   |
| [21b5](https://unicode-table.com/ru/)  | ↵     | ապացույցի ավարտ  |   `/` `<`   |
